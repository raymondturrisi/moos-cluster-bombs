...
#-------------------------------------------------------------- 
#   Script: setup_container.sh     
#   Author: Raymond Turrisi
#   LastEd: Oct. 2023
#   Desc: Sets up the container for my specific needs and missions
#-------------------------------------------------------------- 

### << Ran inside of container (Docker or Singularity) >>

### This is where I setup the container to contain all the mission specific needs. Assumes the host computer has ssh keys on the remote servers
